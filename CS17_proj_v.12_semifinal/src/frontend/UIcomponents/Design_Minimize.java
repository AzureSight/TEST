...
public class Design_Minimize extends JLabel{
	...
	public Design_Minimize(String text, int borderRadius, JPanel panel, Color backgroundColor, Color hoverColor, JPanel panel1, Color colorClicked) {
        super(text);
		...
		addMouseListener(new MouseAdapter() {	
				...
				public void mouseClicked(MouseEvent e) {
					...
					panel1.setBackground(colorClicked);
				}
